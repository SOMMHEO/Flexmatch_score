...
def main():
    ...
    ## seperate not_conntected_user and connected_user
    nc_unique_user = recent_user_info_mtr[recent_user_info_mtr['connacnt_conn_yn']=='N']['acnt_id'].to_list()
    ...
    # ------- connected_user_data --------
    c_recent_user_info_mtr_2 = recent_user_info_mtr_2[~recent_user_info_mtr_2['acnt_id'].isin(nc_unique_user)]

    c_time_series_profile_info = time_series_profile_info[~time_series_profile_info['acnt_id'].isin(nc_unique_user)]
    c_time_series_profile_info_2 = time_series_profile_info_2[~time_series_profile_info_2['acnt_id'].isin(nc_unique_user)]
    
    c_by_user_id_media_dtl_info_2 = by_user_id_media_dtl_info_2[~by_user_id_media_dtl_info_2['acnt_id'].isin(nc_unique_user)]
